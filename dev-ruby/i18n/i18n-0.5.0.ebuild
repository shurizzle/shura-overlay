...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/i18n/i18n-0.5.0.ebuild,v 1.2 2010/12/04 16:41:36 grobian Exp $
...
# The test suite now depends on test_declarative which has no license
# information. Restricting tests for now until it can be added.
RESTRICT="test"
