...
# $Header: /var/cvsroot/gentoo-x86/media-sound/qjackctl/qjackctl-0.3.7.ebuild,v 1.3 2011/02/13 12:24:49 armin76 Exp $
...
IUSE="${IUSE} alsa dbus debug portaudio"

qt_rdeps_add "x11-libs/qt-core:4
	x11-libs/qt-gui:4
	dbus? ( x11-libs/qt-dbus )"
RDEPEND="${RDEPEND} alsa? ( media-libs/alsa-lib )
