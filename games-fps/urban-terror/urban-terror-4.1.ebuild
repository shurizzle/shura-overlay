...
SRC_URI="ftp://ftp.snt.utwente.nl/pub/games/${PN/-/}/io${PN/-/}/source/complete/ioUrbanTerrorSource_2007_12_20.zip
...
src_install() {
	...
	echo "seta cl_cURLLib \"/usr/lib/libcurl.so\"" >> autoexec.cfg
